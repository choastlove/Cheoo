...
module.exports = {
  name: 'H',  // 项目的名字
  favicon: 'http://react-china.org/uploads/default/37/58d7637262ac6228.png',  // 设置网页的favicon, 可以是外链, 也可以是本地
  footer: '<a target="_blank" href="choastlove.github.io">choastlove</a>&nbsp;版权所有 © 2018-2019',  // footer中显示的字, 可以嵌入html标签
